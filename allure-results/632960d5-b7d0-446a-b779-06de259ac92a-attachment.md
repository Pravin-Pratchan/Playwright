...
Call log:
  - waiting for locator('.multiselect-item.multiselect-all')
    - locator resolved to <li class="multiselect-item multiselect-all">…</li>
...
> 7  |   await page.locator('.multiselect-item.multiselect-all').check();
     |                                                           ^ Error: locator.check: Error: Not a checkbox or radio button
  ...
  10 |   await expect (await page.locator("//label[normalize-space()='JavaScript']")).toBeChecked();
