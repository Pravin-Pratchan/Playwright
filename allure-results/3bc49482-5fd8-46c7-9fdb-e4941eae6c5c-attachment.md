...
- table:
  ...
  - rowgroup:
    - row "Chrome 0.10 MB/s 1.1% 5.7 Mbps 57.8 MB":
      - cell "Chrome"
      - cell "0.10 MB/s"
      - cell "1.1%"
      - cell "5.7 Mbps"
      - cell "57.8 MB"
    - row "System 0.79 MB/s 7.4% 2.7 Mbps 48.1 MB":
      - cell "System"
      - cell "0.79 MB/s"
      - cell "7.4%"
      - cell "2.7 Mbps"
      - cell "48.1 MB"
    - row "Firefox 0.28 MB/s 6.6% 2.3 Mbps 72.5 MB":
      - cell "Firefox"
      - cell "0.28 MB/s"
      - cell "6.6%"
      - cell "2.3 Mbps"
      - cell "72.5 MB"
    - row "Internet Explorer 0.65 MB/s 4.6% 10.0 Mbps 46.2 MB":
...
> 6  | await expect(page.locator('#colours')).toHaveValue('[Red\", \"Blue\", \"Yellow\"]');
     |                                        ^ Error: expect(locator).toHaveValue(expected) failed
