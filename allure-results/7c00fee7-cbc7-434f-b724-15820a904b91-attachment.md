...
Call log:
  - waiting for locator('.multiselect')
    - locator resolved to <button type="button" aria-expanded="true" title="None selected" data-toggle="dropdown" class="multiselect dropdown-toggle btn btn-default">…</button>
...
> 7  |   await page.locator('.multiselect').selectOption('PHP');
     |                                      ^ Error: locator.selectOption: Error: Element is not a <select> element
